...
document.addEventListener('DOMContentLoaded', function() {
    fetch('/api/config').then(r => r.json()).then(d => {
        ...
        const demoData = {
            ...
            FUEL_INT_DIGITS: 1, FUEL_DEC_DIGITS: 1, ODO_INT_DIGITS: 5, ODO_DEC_DIGITS: 1, MIN_SATELLITES: 5, OPTIMAL_SATELLITES: 8, MAX_SPEED_DELTA_KMH: 5, GPS_MIN_DEV_KMH: 2, GPS_ONLY_MODE: false, GPS_START_KMH: 3, GPS_STOP_SETTLE_MS: 1500,
            GPS_BAUD: 115200, HEADING_DIGITS: 3, REFRESH_COMPASS_MS: 200, COMPASS_DECLINATION_DEG: 0, GPS_DEBUG_DEFAULT: false,
