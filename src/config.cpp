...
int ALIGN_BIG_TIME = ALIGN_CENTER;
int ALIGN_BIG_DATE = ALIGN_CENTER;
int ALIGN_BIG_SIGNATURE = ALIGN_CENTER;
int ALIGN_BIG_SPEED_NUM = ALIGN_CENTER;
int ALIGN_BIG_SPEED_UNIT = ALIGN_CENTER;
int ALIGN_BIG_ODO = ALIGN_RIGHT;
int ALIGN_BIG_SAT = ALIGN_CENTER;
int ALIGN_BIG_TMR = ALIGN_CENTER;
int ALIGN_BIG_BAT = ALIGN_CENTER;
int ALIGN_SIDEBAR_LEFT = ALIGN_CENTER;
int ALIGN_SIDEBAR_RIGHT = ALIGN_CENTER;
int ALIGN_HALL_ICON = ALIGN_CENTER;
int ALIGN_GPS_ICON = ALIGN_CENTER;
int ALIGN_WHEEL_ICON = ALIGN_CENTER;
int ALIGN_WIFI_ICON = ALIGN_CENTER;
...
void processConfig(int mode, JsonDocument *doc) {
  ...
  CFG_INT(REFRESH_AVG_MS, "R_AVG", 0);
