...
char WEATHER_CITY[48] = "Mestre";
float WEATHER_LAT = 45.4939f;
float WEATHER_LON = 12.2414f;
...
char WIFI_SSID[64] = "D-Link-627F3B";
char WIFI_PASSWORD[64] = "";
char WIFI_SSID_1[64] = "Xiaomi 15";
char WIFI_PASSWORD_1[64] = "GDk2DxjVDc";
char WIFI_SSID_2[64] = "D-Link-627F3B";
char WIFI_PASSWORD_2[64] = "";
char WIFI_SSID_3[64] = "D-Link-627F3B";
char WIFI_PASSWORD_3[64] = "";
char WIFI_SSID_4[64] = "D-Link-627F3B";
...
void processConfig(int mode, JsonDocument *doc) {
  ...
  CFG_STR(WEATHER_CITY, "WEATH_CITY", "Mestre");
  CFG_FLT(WEATHER_LAT, "WEATH_LAT", 45.4939f);
  CFG_FLT(WEATHER_LON, "WEATH_LON", 12.2414f);
  ...
  CFG_STR(WIFI_SSID_1, "WIFI_S1", "Xiaomi 15");
  CFG_STR(WIFI_SSID_2, "WIFI_S2", "D-Link-627F3B");
  CFG_STR(WIFI_SSID_3, "WIFI_S3", "D-Link-627F3B");
  CFG_STR(WIFI_SSID_4, "WIFI_S4", "D-Link-627F3B");
...
const char FACTORY_DEFAULT_JSON[] = R"({
  ...
  "ODO_INT_DIGITS": 5,
  "ODO_DEC_DIGITS": 1,
  "WIFI_SSID": "D-Link-627F3B",
  "WIFI_SSID_1": "Xiaomi 15",
  "WIFI_SSID_2": "D-Link-627F3B",
  "WIFI_SSID_3": "D-Link-627F3B",
  "WIFI_SSID_4": "D-Link-627F3B",
